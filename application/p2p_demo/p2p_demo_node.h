...
#ifndef _P2P_DEMO_FWD_NODE_H_
#define _P2P_DEMO_FWD_NODE_H_
...
#define DEVICE_SELF_ID	                   (0x03)
#define DEMO_BOOT                           (0x10)
#define DEMO_FWD                            (0x20)
